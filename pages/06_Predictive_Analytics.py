...
st.set_page_config(page_title="Predictive Analytics - SPK Dashboard", layout="wide", initial_sidebar_state="expanded")
...
# Sequences
try:
    execute_db_query("CREATE SEQUENCE IF NOT EXISTS model_id_seq START 1")
    execute_db_query("CREATE SEQUENCE IF NOT EXISTS prediction_id_seq START 1")
except:
    pass
...
def load_fitness_data():
    ...
    fitness_data = execute_db_query(fitness_query)
...
def load_gps_data():
    ...
    gps_data = execute_db_query(gps_query)
...
def load_advanced_gps_metrics():
    ...
    gps_data = execute_db_query(gps_advanced_query)
...
with tab3:
    ...
    if not df_fitness.empty:
        ...
        match_minutes = execute_db_query("""
            SELECT 
                m.datum, 
                m.tegenstander, 
                ml.minuten_gespeeld,
