...
if not table_exists:
    ...
    st.subheader(f"👥 Groepsindeling voor training (basis: {metric_keuze}) - Maand: {maand_selectie}")
    ...
    if df.empty:
        ...
        zones = zone_df.dropna(subset=[base_column]).drop_duplicates(subset=["Speler"]).copy()
